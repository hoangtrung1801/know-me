/**
 * E2E test helpers — start/stop knowme server with isolated project
 */
...
const defaultBinary = resolve(
	__dirname,
	isWindows ? "../../bin/knowme.exe" : "../../bin/knowme",
);
...
/**
 * Start a knowme server with an isolated temporary project.
