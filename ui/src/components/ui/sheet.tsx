...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background p-6 shadow-[var(--shadow-dialog)] transition ease-in-out data-[state=closed]:duration-150 data-[state=open]:duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
