...
```bash
# Create a new task
knowme task create "Add new feature X" \
...
1. Go to [Issues](https://github.com/hoangtrung1801/know-me/issues)
2. Click **"New Issue"**
...
knowme task edit <id> -s in-progress -a @me
knowme time start <id>
```
...
knowme task edit <id> --append-notes "Merged in PR #XX"
...
# If not done:
knowme task edit <id> --check-ac 1 --check-ac 2 --check-ac 3
```
...
1. **Review Draft Release**
   - Go to [Releases](https://github.com/hoangtrung1801/know-me/releases)
...
# List your tasks
knowme task list --assignee @me --status in-progress --plain

# View task tree
knowme task list --tree --plain
...
**Questions?** Open an issue with the `question` label or start a [Discussion](https://github.com/hoangtrung1801/know-me/discussions).
