...
func (a *PythonAdapter) InstallGuide() lsp.InstallGuide {
	return lsp.InstallGuide{Command: "pip install python-lsp-server", KnownsCmd: "knowme lsp install python", Notes: "Requires Python 3.9+ installed; pyright-langserver is also supported"}
}
