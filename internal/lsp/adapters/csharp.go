...
func (a *RoslynAdapter) InstallGuide() lsp.InstallGuide {
	return lsp.InstallGuide{Command: "knowme lsp install csharp", KnownsCmd: "knowme lsp install csharp", URL: "https://www.nuget.org/packages/Microsoft.CodeAnalysis.LanguageServer.neutral", Notes: "Downloads Roslyn LS from NuGet and requires .NET SDK 10+"}
}
