...
func (a *ScssAdapter) InstallGuide() lsp.InstallGuide {
	return lsp.InstallGuide{Command: "npm install -g some-sass-language-server", KnownsCmd: "knowme lsp install scss", Notes: "Requires Node.js 18+; handles .scss, .sass, and .css files"}
}
