...
func (a *ClangdAdapter) InstallGuide() lsp.InstallGuide {
	return lsp.InstallGuide{KnownsCmd: "knowme lsp install c_cpp", URL: "https://clangd.llvm.org/installation", Notes: "Standalone clangd binaries can be installed by Know-Me for supported platforms"}
}
