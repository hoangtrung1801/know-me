...
| Input | Create |
| --- | --- |
| Quick note, idea, or other short item | Memo: `knownme memo add "<content>"` |
| Work or a task to track | Task: `knownme task create "<title>" --ac "<acceptance criteria>"` |
| A URL or link | Link: `knownme link add <url>` |
