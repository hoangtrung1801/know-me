...
Know-Me cũng hỗ trợ user-level setup khi phù hợp. Ví dụ, `knowme setup codex --global` cài user-level MCP config, skills, và runtime hooks để assistant integration đi theo bạn qua nhiều repository.
